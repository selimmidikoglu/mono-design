...
class Preview extends Component {
  ...
  render () {
    ...
    console.log ('Girdik sıctımın previne');
        ...
        <View style={styles.container}>
          <View
            style={{
              ...
              height: dimensionsObj.height*14/16,
          ...
          >
            <Image
              style={styles.image}
              resizeMode="contain"
              source={{uri: this.props.prevReducer.uri}}
            />
          </View>
          {this.state.bottomBarVisible
            ? <View style={styles.buttonsContainer}>
                <View style={styles.buttonMiddleContainer}>
                 
                    <TouchableOpacity
                      style={styles.shareButtonBack}
                      onPress={() => {
                        this.props.renderBottomBar();
                        this.props.navigation.navigate('DesignContainer');
                      }
                      }
                    > 
...
const styles = StyleSheet.create ({
  ...
  image: {
    height: dimensionsObj.height*14/16,
    width: dimensionsObj.width*14/16,
    borderRadius:10,
    
  },
  buttonsContainer: {
    height: dimensionsObj.height*2/16,
    width: dimensionsObj.width,
    alignItems:'center',
    justifyContent:'center'
  },
