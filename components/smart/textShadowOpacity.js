...
//@actions
import {renderTextShadowOpacity} from '../../src/actions/renderOrNotActions';
import {changeTextShadowOpacity} from '../../src/actions/changeTextShadowActions';
class TextShadowOpacity extends Component {
  render () {
    return (
      <View style={styles.container}>
        ...
        > 
            ...
            <View style={{flex:4,textAlign:'center',justifyContent:'center',alignItems:'center'}}>
              <Text style={{marginTop:10,color:'white'}}>Text Shadow Opacity</Text>
            </View>
            <View style={{flex:1,alignItems:'flex-end',justifyContent:'center',marginTop:5,marginLeft:5}}>
              <TouchableOpacity onPress={() => {
                this.props.renderTextShadowOpacity();
        ...
        <View style={{flex: 3, alignItems: 'center'}}>
          <Slider
            onValueChange={(value) => this.props.changeTextShadowOpacity(value)}
            minimumTrackTintColor="gray"
            maximumTrackTintColor="white"
            minimumValue={0}
            maximumValue={1}
            value= {this.props.changeTextShadowReducer.textShadowOpacity}
